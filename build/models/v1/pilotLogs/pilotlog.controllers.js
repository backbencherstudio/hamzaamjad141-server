...
exports.getUserLogs = exports.getAllUserLogSummaries = exports.getLogSummary = exports.deleteLog = exports.getLogbook = exports.instructorReject = exports.instructorApprov = exports.createLog = void 0;
...
const createLog = async (req, res) => {
    try {
        ...
        (0, emailService_utils_1.instructorConformations)(instructor.email, user.name, {
            ...newLog,
...
const instructorApprov = async (req, res) => {
    try {
...
exports.instructorApprov = instructorApprov;
const instructorReject = async (req, res) => {
    try {
        const logId = req.query;
        const exitAddlog = await prisma.addLog.findFirst({
            where: { id: logId },
...
exports.instructorReject = instructorReject;
...
const getAllUserLogSummaries = async (req, res) => {
    try {
        const page = parseInt(req.query.page) || 1;
        const limit = parseInt(req.query.limit) || 10;
...
exports.getAllUserLogSummaries = getAllUserLogSummaries;
...
//# sourceMappingURL=pilotlog.controllers.js.map